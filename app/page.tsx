      ...
      <TabNav active={tab} onChange={setTab} />
        ...
        {loading && !active.length ? (
          ...
          <>
            ...
            {tab === "demo"      && <DemoTab deals={demo} allActive={active} closePlans={closePlans} now={now} weekAgo={weekAgo} qStart={qStart} demoQTarget={deriveTargets(assumptions).demoTarget} />}
            {tab === "discovery" && (
              <DiscoveryTab
