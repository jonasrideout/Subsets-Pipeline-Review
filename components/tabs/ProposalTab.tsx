...
export default function ProposalTab({ deals, closePlans, onClosePlanSave, committedIds, onToggleCommit, now, weekAgo, qStart, counts, propQTarget }: ProposalTabProps) {
